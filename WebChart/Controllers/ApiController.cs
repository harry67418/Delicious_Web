...
namespace WebChart.Controllers
{
    ...
    public class ApiController : Controller
    {
        ...
        public ApiController(  IWebHostEnvironment hostingEnvironment, DeliciousContext delicious)
        {
        ...
        {
            var RecipeCategory = _delicious.Tsteps.Where(n=>n.RecipeId == id).Select(n => new
            {
                n.StepsNumber,
                n.Steps,
                n.Picture
        ...
        public IActionResult Addorder([FromBody] object oContext)
        {
            ...
            foreach (var item in cCartItemModel)
            {
                ...
                detail.Price = Convert.ToInt32(item.unitprice.Replace("元",""));
                detail.Discount = 0;
