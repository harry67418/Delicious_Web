...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=tcp:msit130001.database.windows.net,1433;Initial Catalog=Delicious;Persist Security Info=False;User ID=msit130001;Password=@qwe123123;MultipleActiveResultSets=True;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TmemberFollow>(entity =>
            {
                ...
                entity.ToTable("TMemberFollows");

                entity.Property(e => e.FollowId).HasColumnName("FollowID");

                entity.Property(e => e.FollowMemberId).HasColumnName("FollowMemberID");

                entity.Property(e => e.MemberId).HasColumnName("MemberID");

                entity.HasOne(d => d.FollowMember)
                    .WithMany(p => p.TmemberFollowFollowMembers)
                    .HasForeignKey(d => d.FollowMemberId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_TMemberFollows_TMember1");

                entity.HasOne(d => d.Member)
                    .WithMany(p => p.TmemberFollowMembers)
                    .HasForeignKey(d => d.MemberId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_TMemberFollows_TMember");
            });
